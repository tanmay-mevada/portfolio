...
export const projects = [
  ...
  },
  {
    ...
    date: "May, 2023",
    description:
      "A simple Marksheet Generator that reads data and generates a text based marksheet.",
    tech: ["C++"],
  ...
  },
  {
    ...
    date: "November, 2023",
    description:
      "A project that manages user health data to calculate & categorize BMI with various features.",
  ...
  },
  {
    ...
    date: "December, 2023",
    description:
      "A responsive website having contact form, carousel, slidebar & many more",
  ...
  },
  {
    ...
    date: "December, 2023",
    description:
      "A simple responsive website having authentication, cards, slidebar etc.",
  ...
  },
  {
    ...
    date: "May, 2024",
    description:
      "About Simple EMS that manages the data and generate electricity bills using Java and DB through CMD",
    tech: ["Java", "MySQL", "iTextPDF"],
    images: [proj7x1, proj7x2, proj7x3, proj7x4],
    github:
      "https://github.com/tanmay-mevada/Electricity-Management-System-Basic",
    live: "",
    status: "completed",
    projectType: "solo",
    features: [
  ...
  },
  {
    ...
    date: "January, 2024",
    description:
      "A refurbished hostel management website with CRUD operation and authentication. [Based on Astro-Code HMS]",
    tech: ["PHP", "MySQL"],
  ...
  },
  {
    ...
    date: "May, 2024",
    description:
      "An upgraded version of EMS-Basic with better UI and Webapp integration.",
    tech: ["Java", "Maven", "Servlets", "JSP", "XML", "MySQL", "iTextPDF"],
    images: [proj9x1, proj9x2, proj9x3, proj9x4],
    github:
      "https://github.com/tanmay-mevada/Electricity-Management-System-Enhanced",
    live: "",
    status: "completed",
    projectType: "solo",
    features: [
  ...
  },
  {
    ...
    date: "June, 2024",
    description:
      "A machine learning project that gives estimation of trip cost breaking down into food, stay and travel expenses and generates pi-chart for given places from Ahmedabad",
    tech: [
      "Python",
      "Pandas",
      "NumPY",
  ...
  },
  {
    ...
    date: "September, 2024",
    description:
      "An android login/signup application that uses local database.",
  ...
  },
  {
    ...
    date: "September, 2024",
    description:
      "An android login/signup application that uses firbase database.",
  ...
  },
  {
    ...
    date: "July, 2025",
    description:
      "A learning platform that helps diploma students learning DSA with interactive content.",
    tech: [
      "NextJS",
      "TypeScript",
      "MongoDB",
  ...
  },
  {
    ...
    date: "September, 2025",
    description:
      "A hardware-only OTP generator and verifier in Logisim using LFSR-based pseudo-random logic.",
  ...
  },
  {
    ...
    date: "November, 2025",
    description:
      "An AI-powered platform that simplifies legal documents with instant summaries, risk detection, and plain-language explanations.",
    tech: [
      "NextJS",
      "FastAPI",
      "GCP",
  ...
  //   date: "January, 2026",
  //   description:
  //     "A role-based HR management platform that streamlines employee onboarding, attendance tracking, leave approvals, and payroll visibility for both employees and HR administrators.",
  //   tech: [
  //     "Next.js",
  //     "MongoDB",
  //     "Tailwind CSS",
  ...
  //   ],
  //   images: [proj17x1, proj17x2, proj17x3, proj17x4],
  //   github: "https://github.com/tanmay-mevada/Dayflow",
  //   live: "",
  //   status: "maintained",
  //   projectType: "team",
  //   features: [
